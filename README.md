...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8mbqbcw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8mbqbcw.containers.anotherwebservice.com/
...
```
git clone git@github.com:ar3h1d/container-8mbqbcw.git
cd container-8mbqbcw
```
...
```
docker attach container-8mbqbcw
```
